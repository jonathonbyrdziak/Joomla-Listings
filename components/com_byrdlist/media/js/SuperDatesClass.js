...
/**
 * gets the number of nights difference between two dates
 */
Date.prototype.getNights = function (date) {
	var difference = date - this;
	var nights = difference / 86400000;
	nights = Math.round(nights*1)/1;
	nights = nights +'';

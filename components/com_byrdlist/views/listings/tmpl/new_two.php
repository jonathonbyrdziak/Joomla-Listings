...
<div id="listing"> 
	...
	<div class="column first">
		...
		<tr> 
			<td> 
				<h1 style="font-size:14px;margin-top:10px;">Would you like to donate these earnings to a Financial Campaign?</h1> 
			</td> 
			</tr> 
			<tr> 
			<td>
				<?php $this->element('dropdown_financials'); ?>
			</td> 
		</tr>
		
		<tr> 
			<td> 
				<h1 style="font-size:14px;margin-top:10px;">Choose one Category:</h1> 
			</td> 
			</tr> 
			<tr> 
			<td>
		...
		<tr> 
			<td class="mbutton"> 
				...
				<a href="?option=com_byrdlist&view=listings&layout=new&record=<?php echo $this->_record->id(); ?>" rel="nofollow">
				Back</a>
	...
	<div class="column second">
		<form action="?option=com_byrdlist&view=listings&format=ajax&layout=ajaxupload" method="post" name="sleeker" id="sleeker" enctype="multipart/form-data">
			<input type="hidden" name="_listings_id" value="<?php echo $this->id; ?>" /> 

...
<div id="listing"> 
	...
	<?php if (!$this->user->isDonor()): ?>
			...
			<table border="0" cellpadding="3" cellspacing="0" width="100%"> 
				<tr> 
					<td> 
						<h1 style="font-size:14px;">Your Organization:</h1> 
					</td> 
				</tr> 
				<tr> 
				...
				<tr>
					<td>
						<h1 style="font-size:14px;margin-top:10px;">Why do you need this Donation?</h1> 
					</td>
				</tr> 
				<tr>
					<td>
			...
			<input type="hidden" name="layout" value="request" /> 
			<input type="hidden" name="task" value="save" /> 
			<input type="hidden" name="Itemid" value="<?php echo JRequest::getVar('Itemid'); ?>" />
			
			</form> 
	<?php else: ?>
		<span class="warning">Donor's cannot Request Items.</span>
	<?php endif; ?>
	</div>

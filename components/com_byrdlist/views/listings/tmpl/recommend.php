...
<div id="listing"> 
	...
	<div class="column first">
		...
		<table border="0" cellpadding="3" cellspacing="0" width="100%">
			<tr> 
			<td> 
				<h1 style="font-size:14px;">Your Friends Email:</h1> 
			</td> 
			</tr> 
			<tr> 
			<td>
				<input type="text" name="email" class="inputbox" style="width:530px" value="" />
			</td> 
			</tr>
			<tr> 
			<td> 
				<h1 style="font-size:14px;margin-top:10px;">Subject:</h1> 
			</td> 
			</tr> 
			<tr> 
			<td>
				<input type="text" name="name" class="inputbox" style="width:530px" 
				value="I found you something on idozo.org :: <?php echo $this->_listings->name(); ?>" />
			</td> 
			</tr>
			<tr>
			<td>
...
I found this listing on http://idozo.org and I thought that it might interest you. Click the link below and it will take you to the listing.
				
<?php echo DOTCOM; ?>?option=com_byrdlist&view=listings&layout=details&record=<?php echo $this->_listings->id(); ?>
		...
		<input type="hidden" name="layout" value="recommend" /> 

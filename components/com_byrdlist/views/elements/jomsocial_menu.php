		...
		<ul id="cToolbarNavList"> 
		    ...
		    <li id="toolbar-item-friends" class=""> 
      		...
      		<li id="toolbar-item-apps" class=""> 
				<a href="/index.php?option=com_community&amp;view=apps&amp;Itemid=14" onmouseover="joms.toolbar.open('m3')" onmouseout="joms.toolbar.closetime()">
				Applications</a> 
      		...
      		<li id="toolbar-item-inbox" class=""> 
				<a href="/index.php?option=com_community&amp;view=inbox&amp;Itemid=14" onmouseover="joms.toolbar.open('m4')" onmouseout="joms.toolbar.closetime()">
				Inbox</a> 
		        <div id="m4" onmouseover="joms.toolbar.cancelclosetime()" onmouseout="joms.toolbar.closetime()" style="visibility: hidden;"> 
				    <a href="/index.php?option=com_community&amp;view=inbox&amp;Itemid=14">
				    Inbox</a> 
				    <a href="/index.php?option=com_community&amp;view=inbox&amp;task=sent&amp;Itemid=14">
				    Sent</a> 
					<a href="/index.php?option=com_community&amp;view=inbox&amp;task=write&amp;Itemid=14">
					Write</a> 
		        </div> 
			</li> 
			
			<li id="toolbar-item-mylisting"  class="toolbar-active"> 
				<a href="/index.php?option=com_byrdlist&view=myaccount&Itemid=14" onmouseover="joms.toolbar.open('m5')" onmouseout="joms.toolbar.closetime()">
				My listings</a> 
			    <div id="m5" onmouseover="joms.toolbar.cancelclosetime()" onmouseout="joms.toolbar.closetime()" style="visibility: hidden;"> 
				    <a href="/index.php?option=com_byrdlist&view=listings&layout=new&Itemid=14">
				    Add New Listing</a>
		        </div> 
			</li> 
			...
			<li id="toolbar-item-mylisting" >
				<a href="?option=com_byrdlist&view=authors&layout=details&Itemid=14" onmouseover="joms.toolbar.open('m6')" onmouseout="joms.toolbar.closetime()">
				My Website</a>
			    <div id="m6" onmouseover="joms.toolbar.cancelclosetime()" onmouseout="joms.toolbar.closetime()" style="visibility: hidden;"> 
				    <a href="/index.php?option=com_byrdlist&view=authors&layout=new&Itemid=14">
				    Add New Webpage</a>
		        </div> 
			</li>
		</ul> 

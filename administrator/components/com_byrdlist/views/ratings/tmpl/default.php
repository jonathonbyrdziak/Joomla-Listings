...
<?php JToolBarHelper::title('Ratings', 'generic.png'); ?>
...
<div id="element-box"> 
	...
	<div class="m"> 
		<form action="index.php?option=com_byrdlist&view=ratings" method="post" name="adminForm"> 
				...
				<tr> 
					...
					<th class="title"> 
						...
						title="Click to sort by this column">
							Listing Names <img src="/administrator/images/sort_asc.png" alt=""  /></a>
					</th> 
					<th class="title" width="10%"> 
						<a href="javascript:tableOrdering('c.title','desc','');" 
						title="Click to sort by this column">
							Ratings <img src="/administrator/images/sort_asc.png" alt=""  /></a>
					</th>

...
<?php $this->element('toolbar_default'); ?>
<?php JToolBarHelper::title('Payments Made', 'generic.png'); ?>
...
<div id="element-box"> 
	...
	<div class="m"> 
		<form action="index.php?option=com_byrdlist&view=payments" method="post" name="adminForm"> 
				...
				<tr> 
					...
					<th class="title" width="10%"> 
						...
						title="Click to sort by this column">
							Amount <img src="/administrator/images/sort_asc.png" alt=""  /></a>
					</th> 
					<th class="title"> 
						<a href="javascript:tableOrdering('c.title','desc','');" 
						title="Click to sort by this column">
							Reference Number <img src="/administrator/images/sort_asc.png" alt=""  /></a>
					</th> 
					<th class="title" width="12%"> 
						<a href="javascript:tableOrdering('c.title','desc','');" 
						title="Click to sort by this column">
							Gateway <img src="/administrator/images/sort_asc.png" alt=""  /></a>
					</th>

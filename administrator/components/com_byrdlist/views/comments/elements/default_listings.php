<tr class="row<?php echo $row; ?>"> 
	...
	<td> 
		...
		<a href="index.php?option=com_byrdlist&view=comments&layout=edit&record=<?php echo $record->id(); ?>"> 
			<?php echo $record->name(); ?>
		</a> 
		</span>
	</td>  
	<td> 
		<a href="index.php?option=com_byrdlist&view=comments&layout=edit&record=<?php echo $record->listing_id(); ?>"> 

...
<?php JToolBarHelper::title('Images', 'generic.png'); ?>
...
<div id="element-box"> 
	...
	<div class="m"> 
		<form action="index.php?option=com_byrdlist&view=images" method="post" name="adminForm"> 
				...
				<tr> 
					...
					<th class="title"> 
						...
						title="Click to sort by this column">
							Image Name <img src="/administrator/images/sort_asc.png" alt=""  /></a>
					</th> 
					<th class="title"> 
						<a href="javascript:tableOrdering('c.title','desc','');" 
						title="Click to sort by this column">

...
<?php JToolBarHelper::title('Reported Listings', 'generic.png'); ?>
...
<div id="element-box"> 
	...
	<div class="m"> 
		<form action="index.php?option=com_byrdlist&view=reported" method="post" name="adminForm"> 
			...
			<thead> 
				<tr> 
					...
					<th class="title" width="12%"> 
						<a href="javascript:tableOrdering('c.title','desc','');" 
						title="Click to sort by this column">
							Violation <img src="/administrator/images/sort_asc.png" alt=""  /></a>
					</th> 

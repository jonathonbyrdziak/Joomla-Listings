...
<?php JToolBarHelper::title('Categories', 'generic.png'); ?>
...
<div id="element-box"> 
	...
	<div class="m"> 
		<form action="index.php?option=com_byrdlist&view=categories" method="post" name="adminForm"> 
			<!-- 
			<table> 
				<tr> 
					<td width="100%"> 
			...
			<thead> 
				<tr> 
					...
					<th class="title" width="12%" nowrap="nowrap"> 
						...
						title="Click to sort by this column">
							Parent Category<img src="/administrator/images/sort_asc.png" alt=""  />
						</a>
					</th>
			...
			<tbody> 
				<?php $this->element('listing_category'); ?>	
			</tbody> 
		</table> 

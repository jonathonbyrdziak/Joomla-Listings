<tr class="row<?php echo $row; ?>"> 
	...
	<td> 
		...
		<a href="index.php?option=com_byrdlist&view=categories&layout=edit&record=<?php echo $record->id(); ?>"> 
	...
	<td>
	<a href="index.php?option=com_byrdlist&view=categories&layout=edit&task=edit&record=<?php echo $record->parent_id(); ?>" 
		title="Edit Parent Category"> 
		<?php echo $record->parent_name(); ?>
	</a>
	</td>
	<td>

...
<?php JToolBarHelper::title('Auction Bids', 'generic.png'); ?>
...
<div id="element-box"> 
	...
	<div class="m"> 
		<form action="index.php?option=com_byrdlist&view=bids" method="post" name="adminForm"> 
				...
				<tr> 
					...
					<th class="title"> 
						...
						title="Click to sort by this column">
							Listing Title <img src="/administrator/images/sort_asc.png" alt=""  /></a>
					</th> 
					<th width="1%" nowrap="nowrap"> 
						<a href="javascript:tableOrdering('c.state','desc','');" 
						title="Click to sort by this column">
